...
def test_cadastrar_item(mocker):
    ...
    mocker.patch('cadastros.gerar_id_produto', return_value = 123)
    mocker_gravar = mocker.patch('manipulacaoArquivos.gravarProdutoFakeStore')
    mocker_mensagem = mocker.patch('interface.mensagem_sucesso')
...
def test_excluir_item(mocker):
    ...
    mocker.patch('manipulacaoArquivos.lerProdutosLocais', return_value = lista_falsa)
